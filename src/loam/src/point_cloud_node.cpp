    ...
    public:
        ...
        void callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg_ptr)
        {
            ...
            *old_cloud = *cloud;
            ...
            pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZI> source_handler(cloud, 155.0, 155.0, 0.0);
            pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZI> aligned_handler(full_cloud, 0.0, 155.0, 155.0);
